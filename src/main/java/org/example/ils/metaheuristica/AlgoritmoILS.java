...
public class AlgoritmoILS extends AlgoritmoAbstract {
  ...
  public SolucaoILS modificaSolucaoPorMetodosSelecionadosAleatoriamente(SolucaoILS solucaoAtual) {
    ...
    int perturbacaoSelecionada = GeradorSolucao.randInt(0,
        this.metodosPerturbacaoDisponiveis.length - 1);
  ...
  public void executa(String... args) {
    ...
    if (this.metodosPerturbacaoSimultaneos) {
      while (this.evaluation < this.evaluationMax) {
        ...
        if (this.maxIteracoesSemMelhoria != 0
      ...
      while (this.evaluation < this.evaluationMax) {
        ...
        SolucaoILS solucaoLinha = modificaSolucaoPorMetodosSelecionadosAleatoriamente(
            solucaoEstrela);
  ...
  public void setConfiguracoes(Parametro param) {
    ...
    if (param.getPercentualMoves() != null) {
      if (param.getPercentualMoves() == 0.00) {
        ...
        this.quantidadeMovimentacoes = Double.valueOf(
            problema.getTamanho() * param.getPercentualMoves() / 100).intValue();
    ...
    if (param.getPercentualSwaps() != null) {
      if (param.getPercentualSwaps() == 0.00) {
        ...
        this.quantidadeSwaps = Double.valueOf(
            problema.getTamanho() * param.getPercentualSwaps() / 100).intValue();
    ...
    if (param.getPercentualSplits() != null) {
      if (param.getPercentualSplits() == 0.00) {
        ...
        this.quantidadeSplits = Double.valueOf(
            problema.getTamanho() * param.getPercentualSplits() / 100).intValue();
    ...
    if (param.getPercentualJoins() != null) {
      if (param.getPercentualJoins() == 0.00) {
        ...
        this.quantidadeJoins = Double.valueOf(
            problema.getTamanho() * param.getPercentualJoins() / 100).intValue();
    ...
    if (param.getPercentualExplosion() != null) {
      if (param.getPercentualExplosion() == 0.00) {
        ...
        this.quantidadeExplosion = Double.valueOf(
            problema.getTamanho() * param.getPercentualExplosion() / 100).intValue();
