...
public class Populacao implements Serializable {
	...
	*/
	...
	public void setDoisMelhores(Solucao[] retorno) {
		...
		// Coleta a primeira e segunda solu��o da popula��o
	...
	*/
	...
	/**
	 * Coleta as duas primeiras solu��es
	 */
	...
	/**
	 * Compara se duas popula��es tem mesma m�dia e elementos homogeneos
	 */
	public int compara(Populacao populacao, int contadorAtual) {
		...
		// Popula��o n�o est� totalmente homog�nea
		if (fitnessInicial1-fitnessFinal1>0.0001)   return 0;
		// Primeiros elementos diferentes nas popula��es
		if (fitnessInicial1-fitnessInicial2>0.0001) return 0;
		// �ltimos elementos diferentes nas popula��es
	...
	/**
	 * Compara se os elementos das popula��es s�o identicos
	 * Usado para testes
	 */
	...
	/**
	 * Compara, considerando que um percentual da popula��o ser� sempre descartado
	 */
	public int comparaConsirandoInsercaoRandomica(Populacao populacao, int contadorAtual, int posicaoLimite) {
		...
		// N�o houve varia��o relevante de fitness
		if (fitnessAtual-fitnessProxima>0.0001)   return 0;
		// N�o houve varia��o da m�dia da popula��o
