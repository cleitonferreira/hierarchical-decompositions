...
import org.example.ils.core.ConverterProblema;
...
public class LeitorProblemaODEM {
  ...
  public static Problema loadODEM(String filename) throws Exception {
    ...
    /*Decomposition decomposition = ConverterProblemaOrientacao.converterProblemaParaDecomposition(
        problema, problema.getOriginalPackage(), subgrupos);
    problema.setDecomposition(decomposition);*/
