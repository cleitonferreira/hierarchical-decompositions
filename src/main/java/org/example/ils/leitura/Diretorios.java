...
public class Diretorios {
  ...
  public static String diretorioInstancias =
      System.getProperty("user.dir") + "//instancias//data//";
  ...
  public static String diretorioInstanciasTXT =
      System.getProperty("user.dir") + "//instancias/data_txt//";
  ...
  public static List<String> getNomesArquivosSaida(List<Parametro> params, int parametroInicial,
      int parametroFinal) {
  ...
  public static List<String> getNomesArquivosDebug(ExperimentoModel experimento) {
    ...
    for (Problema problema : problemas) {
      int indice = 0;
      // loop necess�rio para pegar a configura��o, modificar criando entidade <Problema,Parametro>
  ...
  public static String getNomeArquivoResumoCSVEmColuna(ExperimentoModel experimento,
      String nomeColuna) {
  ...
  public static String getNomeArquivoResumoWilcoxCSV(ExperimentoModel experimento,
      String nomeColuna) {
    return "SAIDA RESULTADOS WILCOX - " + experimento.getIdExperimento() + " - " + nomeColuna
        + ".csv";
  }
}
