...
public class Exibicao {
	...
	public void printCiclo(int cycleNumber, SolucaoAbstract solucao, long executionTime) {
		...
		if (solucao == null) {
			printlnx("Cycle #" + cycleNumber + "; solu��o n�o encontrada.");
			return;
		}
		...
		// grupos
		printlnx(solucao.getGruposString());
	}
