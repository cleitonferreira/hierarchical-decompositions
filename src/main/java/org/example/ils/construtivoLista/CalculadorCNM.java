...
import org.example.ils.core.RetornoSolucao;


/**
 * DEFINIC�ES:
 * <p>
 * - acoplamento = n�mero de depend�ncias que as classes de um pacote possuem com classes de fora do
 * pacote. Deve ser minimizado.
 * <p>
 * - coes�o = n�mero de depend�ncias que as classes de um pacote possuem com outras classes do mesmo
 * pacote. Deve ser maximizado (ou seja, minimizamos seu valor com sinal invertido)
 * <p>
 * - spread = partindo de zero e percorrendo cada pacote, acumula o quadrado da diferen�a entre o
 * n�mero de classes do pacote e o n�mero de classes do menor pacote
 * <p>
...
public class CalculadorCNM extends Calculador {
  ...
  /**
   * Calcula o fitness que resultado do join de dois clusters, sem modificar a solu��o
   */
  public double evaluateJoin(SolucaoCNMLL s, int cluster1, int cluster2) {
    ...
    RetornoSolucao retornoSolucao = calculateFormulaComplexidade(s, valores);
    double fitness = retornoSolucao.getValorFormulaComplexidade();
    // desfaz a modifica��o
    for (Integer item : itens2) {
  ...
  public double evaluateJoinOtimizado(SolucaoCNMLL s, int cluster1, int cluster2) {
    ...
    // desfaz a modifica��o do join dos clusters
    for (Integer item : itens2) {
      valores[item] = cluster2;
    }
