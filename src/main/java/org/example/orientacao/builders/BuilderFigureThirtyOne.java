...
public class BuilderFigureThirtyOne {
  ...
  public Decomposition build() {
    ...
    Module a280264 = new Module("A280264").
        addNode(n14).
        addNode(n18);

    Module a280265 = new Module("A280265").
        addNode(n7).
        addNode(n11).
        addNode(n12).
        addNode(n13).
    ...
    Module a280266 = new Module("A280266").
        addNode(n1).
        addNode(n3).
        addNode(n4).
        addNode(n5).
    ...
    Module a280268 = new Module("A280268").
        addNode(n2).
        addNode(n8).
        addNode(n9);
