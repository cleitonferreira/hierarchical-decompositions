...
18 - 1 14
*/
public class Figura34 implements Figura {

  public HMD hmd() {

    List<Entidade> listaEntidadesA280271 = new ArrayList<>();
    listaEntidadesA280271.add(new Entidade("0", null));
    listaEntidadesA280271.add(new Entidade("1", Arrays.asList(new Entidade("0"))));
    listaEntidadesA280271.add(new Entidade("6", Arrays.asList(new Entidade("1"))));
    listaEntidadesA280271.add(new Entidade("10", Arrays.asList(new Entidade("1"), new Entidade("6"))));
    ...
    List<Entidade> listaEntidadesA280270 = new ArrayList<>();
    listaEntidadesA280270.add(new Entidade("14", Arrays.asList(new Entidade("2"))));
    listaEntidadesA280270.add(new Entidade("18", Arrays.asList(new Entidade("1"), new Entidade("14"))));

    Modulo moduloA280270 = new Modulo(listaEntidadesA280270, "A280270", null);
    ...
    Modulo moduloA280271 = new Modulo(listaEntidadesA280271, "A280271", Arrays.asList(moduloA280267, moduloA280269));
    Modulo moduloA0 = new Modulo(null, "A0", Arrays.asList(moduloA280267, moduloA280269, moduloA280270, moduloA280271));

    List<Modulo> modulos = new ArrayList<Modulo>();
    modulos.addAll(Arrays.asList(moduloA0, moduloA280267, moduloA280269, moduloA280270, moduloA280271));
